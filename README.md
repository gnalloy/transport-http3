...
- Import path: `gnalloy.org/transport-http3`
- Repository: `github.com/gnalloy/transport-http3`
- Default branch: `dev`
- Preview install: `go get gnalloy.org/transport-http3@dev`
- License: Apache-2.0
...
This repository owns: HTTP/3 transport binding that maps QUIC request, control, QPACK, and push streams into Gnalloy channel pipelines.
